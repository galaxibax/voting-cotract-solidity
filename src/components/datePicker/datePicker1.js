...
const DatePicker1 = (
  ...
  const complete = () => {
    getTime1(selectedTime)
    getDate1(format(selectedDate, "MMMM d, yyyy"))
    setShow1(true)
  }

  return (
    <div className={` ${datePickerStyle} absolute z-30 p-[15px] mt-[-30px] w-[29%] overflow-hidden bg-zinc-900 border-[1px] border-[#FFFFFF33] text-white rounded-[10px]`}>
